...
import com.nacre.resume_builder.exception.ResumeBuilderIOException;
import com.nacre.resume_builder.service.UserService;
@WebServlet("/viewPdf")
public class ViewAsPdfSrv extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ResumeBuilderActionException,IOException {
	    ...
	    table.addCell(graduation.getBoard_of_edu()); table.addCell(graduation.getDop().toString()); table.addCell(""+graduation.getPercentage());
